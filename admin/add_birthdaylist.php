...
$fullname = $entity_no = $date_register = $user_name = $firstname = $middlename = $lastname = $birthdate = $age = $gender = $barangay = $civilstatus = $street = $city = $province = $mobile_no = $telephone_no = $email = '';
                                    ...
                                    <div class="card col-md-6">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-1"></div>
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control" style="text-transform: uppercase;" id="fullname" name="fullname" placeholder="Full Name" onblur="checkFullname()" value="<?php echo $fullname; ?>" required>
                                                    <div id="status1"></div>
                                                </div>
                                            </div></br>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-10">
                                                    ...
                                                    <input type="text" class="form-control" style="text-transform: uppercase;" name="firstname" placeholder="First Name" value="<?php echo $firstname; ?>" required>
                                                </div>
                                            </div></br>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-10">
                                                    ...
                                                    <input type="text" class="form-control" style="text-transform: uppercase;" name="middlename" placeholder="Middle Name" value="<?php echo $middlename; ?>" required>
                                                </div>
                                            </div></br>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-10">
                                                    ...
                                                    <input type="text" class="form-control" style="text-transform: uppercase;" name="lastname" placeholder="Last Name" value="<?php echo $lastname; ?>" required>
                                                </div>
                                            </div><br>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="date" value="" id="date" name="birthdate" class="form-control pull-right " placeholder="dd/mm/yyyy" />
                                                </div>
                                            ...
                                            <div class="box-footer" align="center">
                                                ...
                                                <button type="submit" <?php echo $btnSave; ?> name="insert_birthday" id="btnSubmit" class="btn btn-success">
            ...
            $('#fullname').change(function() {
                if ($('#fscap_id').val() == '') {
                    $.ajax({
                        type: 'POST',
                        data: {},
                        url: 'generate_id2.php',
                        success: function(data) {
                            //$('#entity_no').val(data);
                            document.getElementById("fscap_id").value = data;
                            console.log(data);
                        }
                    });
                }
